...
export GITBUCKET_E2E_GIT_USERNAME="${GITBUCKET_E2E_GIT_USERNAME:-${GITBUCKET_E2E_USER}}"
export GITBUCKET_E2E_GIT_PASSWORD="${GITBUCKET_E2E_GIT_PASSWORD:-${GITBUCKET_E2E_PASSWORD}}"
